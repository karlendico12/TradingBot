...
class TradingWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("TradingBot V8 - FIXED 2R")
        self.resize(650, 600)
        ...
        self.title_label = QLabel("TradingBot V8 - FIXED 2R")
...
class TradingBot:
    ...
    def __init__(self, window):
        ...
        # TRADE LOG
        # ==================================================
        self.trade_log_file = Path("trades_fixed2r.csv")
        ...
        self.active_position_file = Path("active_position_fixed2r.json")
